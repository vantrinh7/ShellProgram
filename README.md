...
This program functions as a shell - a command-line interface for access to services provided by the operating system. It mimics Bash, a widely adopted Unix shell. It runs inside the Terminal application on Mac and Linux. 
